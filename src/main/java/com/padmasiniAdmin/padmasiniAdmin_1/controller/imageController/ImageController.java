...
public class ImageController {
    ...
    // ✅ Constructor injection for region & bucket (configurable via application.properties)
    public ImageController(
        ...
        this.credentialsProvider = DefaultCredentialsProvider.create(); // Auto-picks credentials
    }
    ...
    public ResponseEntity<Map<String, String>> getPresignedUrl(
        ...
        try (S3Presigner presigner = S3Presigner.builder()
            ...
            // Generate a unique key: folderPath + timestamp + original file name
            ...
            PutObjectPresignRequest presignRequest = PutObjectPresignRequest.builder()
                    ...
                    .signatureDuration(Duration.ofMinutes(30)) // Valid for 30 mins
                    .build();
