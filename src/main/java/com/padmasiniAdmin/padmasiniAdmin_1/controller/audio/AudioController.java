...
public class AudioController {
    ...
    // ✅ Use AWS SDK's DefaultCredentialsProvider (works with env vars, config file, or IAM role)
    private final DefaultCredentialsProvider credentialsProvider;

    // ✅ Constructor injection for region & bucket name (configurable via application.properties)
    public AudioController(
        ...
        this.credentialsProvider = DefaultCredentialsProvider.create(); // no need to read env manually
    }
    ...
    public ResponseEntity<?> deleteFileByUrl(@RequestBody Map<String, String> request) {
        ...
        try (S3Client s3 = S3Client.builder()
            ...
            System.out.println("✅ Deleted from S3: " + fileKey);
